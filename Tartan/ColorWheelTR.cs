...
namespace Controlz
{
    ...
    public partial class ColorWheelTR : UserControl
    {
        ...
        protected override void SetBoundsCore(int x, int y, int width, int height, BoundsSpecified specified)
        {
            ...
            base.SetBoundsCore(x, y, 260, 105, specified);
        }
        public double hue
        {
        ...
        {
            Rectangle myrect = new Rectangle(0, 0, 180, 100);
            ...
            Rectangle Lrect = new Rectangle((int)(6.0f * slim), 0, slim, myrect.Height + 2);
            Rectangle Crect = new Rectangle((int)(8.0f * slim) - 2, 2, 27, 27);
            Rectangle Crect2 = new Rectangle((int)(8.0f * slim) - 1, 3, 25, 25);
            ...
            using (Graphics g = Graphics.FromImage(bmp))
            {
                ...
                g.DrawRectangle(Pens.White, Crect2);
        ...
        private void GenColorWheel_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            Rectangle Lrect = new Rectangle((int)(6.0f * slim), 0, slim, myrect.Height);
            Rectangle Lrect2 = new Rectangle((int)(6.0f * slim), 0, slim, myrect.Height + 2);
        ...
        private void rgb_ValueChanged()
        {
            if (!ignore)
            {
                Color _colorval = Color.FromArgb(255, (int)red1.Value, (int)green1.Value, (int)blue1.Value);
                MasterHue = RGBtoHSV(_colorval, MasterHue).Hue;
                MasterSat = RGBtoHSV(_colorval, MasterHue).Sat;
                MasterVal = RGBtoHSV(_colorval, MasterHue).Value;
                MasterAlpha = _colorval.A;
        ...
        private void ColorWheelTR_Load(object sender, EventArgs e)
        {
            Color _colorval = Color.FromArgb(255, 255, 255, 255);
            red1.Value = _colorval.R;
            green1.Value = _colorval.G;
            blue1.Value = _colorval.B;
            MasterHue = RGBtoHSV(_colorval, MasterHue).Hue;
